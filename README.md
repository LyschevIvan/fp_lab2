...
Также достаточной проблемой было бы переопределение оператора "+", поскольку это делается в определении типа, соответственно функции, которые работают с этим типом вне видимости.
Поэтому я сделал функцию Merge
